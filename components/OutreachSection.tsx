...
export function OutreachSection({ country, countrySlug, canonicalUrl }: OutreachSectionProps) {
        ...
        <div className="bg-gray-800 p-8 rounded-lg">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-700 p-4 rounded">
              ...
              <button
                onClick={() => copyToClipboard(partnershipEmail)}
                className="text-blue-400 hover:text-blue-300 font-mono text-sm"
              >
                {copied ? '✓ Email Copied!' : partnershipEmail}
              </button>
            </div>
          </div>
        </div>
